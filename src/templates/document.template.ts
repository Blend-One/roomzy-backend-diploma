...
const documentHTMLTemplate = (data: DocumentTemplateProps) => `
    ...
    <div>
      ...
      Арендодатель предоставляет, а Арендатор принимает во временное владение и пользование жилое помещение, расположенное по адресу: г. Алматы, ул. Абая, д. 10, кв. 15, общей площадью 60.5 кв.м.
    </div>
